...
template<> SIMGPT_API UScriptStruct* StaticStruct<FAqTestStruct>()
{
	...
	struct Z_CompiledInDeferFile_FID_Users_mckra_Documents_GitHub_SimGPTActual_SimGPT_Source_SimGPT_ReadWriteJson_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_mckra_Documents_GitHub_SimGPTActual_SimGPT_Source_SimGPT_ReadWriteJson_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_mckra_Documents_GitHub_SimGPTActual_SimGPT_Source_SimGPT_ReadWriteJson_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_mckra_Documents_GitHub_SimGPTActual_SimGPT_Source_SimGPT_ReadWriteJson_h_416883945(TEXT("/Script/SimGPT"),
		Z_CompiledInDeferFile_FID_Users_mckra_Documents_GitHub_SimGPTActual_SimGPT_Source_SimGPT_ReadWriteJson_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_mckra_Documents_GitHub_SimGPTActual_SimGPT_Source_SimGPT_ReadWriteJson_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Users_mckra_Documents_GitHub_SimGPTActual_SimGPT_Source_SimGPT_ReadWriteJson_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_mckra_Documents_GitHub_SimGPTActual_SimGPT_Source_SimGPT_ReadWriteJson_h_Statics::ScriptStructInfo),
		nullptr, 0);
